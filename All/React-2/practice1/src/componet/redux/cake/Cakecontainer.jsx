    ...
    <>
      <div className="flex justify-center items-center h-screen ">
        ...
        <div className="text-center absolute  ">
          <h1 className="text-3xl font-bold  text-red-500">Number of cake : <span className="text-rose-900 text-4xl">{props.numOfCakes}</span></h1>
          ...
          <h1 className="text-3xl mt-10 text-red-500  font-bold">Number of chocolate : <span className="text-rose-950 text-4xl"> {props.numOfChocolate}</span></h1>
